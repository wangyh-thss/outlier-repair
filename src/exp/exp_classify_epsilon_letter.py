...
if __name__ == '__main__':
    ...
    filenames = {
        'origin': filename,
        'error': filename,
        'test': '../../dataset/classify/data_test_origin',
        'train': '../../dataset/classify/data_train_origin',
    }
    ...
    print result
    write_result(result, epsilon_list, neighbor_k_list, 'result/classification_accuracy_epsilon_letter_origin.dat')
